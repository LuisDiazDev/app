...
class SelectionModal extends StatefulWidget {
  ...
  SelectionModal(
      {this.filterable,
      this.dataSource,
      this.title = 'Escoja una o mas opciones',
      this.values,
      this.textField,
      this.valueField,
      this.maxLength})
                          ...
                          : () {
                              var selectedValuesObjectList =
                                  _localDataSourceWithState
                                      .where((item) => item['checked'])
                                      .toList();
//                            print(selectedValuesObjectList);
                              var selectedValues = [];
    ...
    selectedValues.forEach((item) {
      ...
      selectedOptions.add(Chip(
        label: new Container(
          ...
          child:
              Text("${existingItem['text']}", overflow: TextOverflow.ellipsis),
        ),
        deleteButtonTooltipMessage: 'Toca para eliminar',
...
//        children: <Widget>[
//          new Text(
//            'toque para eliminar el item seleccionado', // use languageService here
//            style: TextStyle(
